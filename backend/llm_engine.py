...
DEFAULT_MODEL_SLOTS = {
    "1": {
        ...
        "provider": "ollama",
        "skin_id": "1",
        "description": "Fast Ollama Cloud reasoning-lite model for quick boxing decisions.",
        "color": "#ffffff",
    },
    "2": {
        "name": "RNJ 1 8B",
        "model_id": "rnj-1:8b-cloud",
        "provider": "ollama",
        "skin_id": "2",
        "description": "Small Ollama Cloud model tuned for quick, light-weight responses.",
        "color": "#f55036",
    },
    "3": {
        ...
        "provider": "ollama",
        "skin_id": "3",
        "description": "Fast coding-oriented Ollama Cloud model pushed to answer with minimal deliberation.",
        "color": "#6ef2ff",
    },
    "4": {
